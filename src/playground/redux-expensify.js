...
const filtersReducer = (state = filtersReducerDefaultState, action) => {
    switch (action.type) {
        case 'SET_TEXT_FILTER':
            // return a new object (never want to modify current state), use object spread operator
            return {
                ...state,
                text: action.text
            };
...
// dispatch gets sent to both reducers, and will run if type matches in reducer
